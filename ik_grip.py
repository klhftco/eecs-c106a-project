...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # Set the desired orientation for the end effector HERE
        request.ik_request.pose_stamped.pose.position.x = 0.722
        request.ik_request.pose_stamped.pose.position.y = 0.527
        request.ik_request.pose_stamped.pose.position.z = -0.148       
        ...
        try:
            ...
            # TRY THIS
            # Setting just the position without specifying the orientation
            # group.set_position_target([0.722, 0.527, -0.148])
